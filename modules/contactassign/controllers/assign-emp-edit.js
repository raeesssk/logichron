// import admin
angular.module('contactassign').controller('assignEditCtrl', function ($rootScope, $http, $scope, $location, $routeParams, $route, $filter) {
/*
...
$scope.apiURL = $rootScope.baseURL+'/assign/employee/total';
   ...
   //Pagination Function
    ...
    $scope.getCampaignEmp=function(){
            $http({
                  method: 'GET',
                  url: $rootScope.baseURL+'/assign/edit',
                  headers: {'Content-Type': 'application/json',
                          'Authorization' :'Bearer '+localStorage.getItem("logichron_admin_access_token")}
                })
                .success(function(dataObj)
                {
                    dataObj.forEach(function(value,key){
                      value.cem_cm_id=value.cm_campaign_name;
                      $scope.assign=value;
