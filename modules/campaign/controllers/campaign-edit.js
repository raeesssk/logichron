  ...
  $scope.getCampaign = function () {
	    ...
	    .success(function(campaignObj)
	    {
	    	...
	    	campaignObj.forEach(function (value, key) {
                ...
                value.cm_restriction = value.cm_restrict;
        ...
        // 1 restriction
          $http({
            ...
            {
                restrict.forEach(function (value, key) {
                    value.restriction = value.crm_restriction;
         ...
         // 2. Account list
            $http({
              ...
              {
                  accountlist.forEach(function (value, key) {
                    value.company = value.amcm_company;
                    value.website = value.amcm_website;
              ...
              $http({
                  ...
                  .success(function(supressionlist)
                  {
                      supressionlist.forEach(function (value, key) {
                          value.company = value.scm_company;
                          value.website = value.scm_website;
              ...
              $http({
                  ...
                  .success(function(domain_limit_list)
                  {
                      domain_limit_list.forEach(function (value, key) {
              ...
              // 5 empsize
               $http({
                  ...
                  .success(function(empsizelist)
                  {
                      empsizelist.forEach(function (value, key) {
                          value.employee_size = value.cesm_employee_size;
                  ...
                  .success(function(jobtitleslist)
                  {
                      jobtitleslist.forEach(function (value, key) {
                          value.titles = value.ctm_title;
                  ...
                  $http({
                    ...
                    .success(function(verticallist)
                    {
                        verticallist.forEach(function (value, key) {
                            value.verticals = value.cvm_verticals;
              ...
              // 8 geo
                ...
                {
                    geolist.forEach(function (value, key) {
                      value.geo = value.cgm_geo;
            ...
            .success(function(allowdomainlist)
            {
                allowdomainlist.forEach(function (value, key) {
            ...
            $http({
              ...
              .success(function(revenuelist)
              {
                  revenuelist.forEach(function (value, key) {
                      value.revenues = value.crem_revenue;
           ...
           $http({
              ...
              .success(function(deniedomainlist)
              {
                  deniedomainlist.forEach(function (value, key) {
          ...
          // 13 asset
            $http({
              ...
              {
                  assetlist.forEach(function (value, key) {
           ...
           $http({
              ...
              .success(function(industrieslist)
              {
                  industrieslist.forEach(function (value, key) {
                      value.industries = value.cim_industries;
        ...
        // 15 dept
            $http({
              ...
              {
                  deptlist.forEach(function (value, key) {
                      value.department = value.cdm_department;
        ...
        // 16 method  
          $http({
            ...
            {
                methodlist.forEach(function (value, key) {
                      value.methodss = value.cmm_method;
            ...
            $http({
              ...
              {
                  levellist.forEach(function (value, key) {
                      value.job_level = value.cjlm_job_level;
      ...
      if($('#cm_first_dely').val() == undefined || $('#cm_first_dely').val() == ""){
        ...
        var dialog = bootbox.dialog({
            ...
            var dialog = bootbox.dialog({
    		    ...
    		    {   
                var dialog = bootbox.dialog({
                  message: '<p class="text-center">Campaign Updated!</p>',
                      closeButton: false
                  });
